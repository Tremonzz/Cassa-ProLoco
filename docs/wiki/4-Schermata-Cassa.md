...
* **Aggiunta al Carrello**: Clicca su una card per aggiungere una porzione al carrello. Ogni click successivo incrementa la quantità. È possibile aggiungere una determinata quantità in una sola volta facendo **clic col tasto destro sulla card** e inserendo la quantità desiderata nell'apposita finestra che si apre.
...
* **Gestire le Quantità**: 
  ...
  * Fai **clic col tasto destro** per impostare direttamente una determinata quantità.

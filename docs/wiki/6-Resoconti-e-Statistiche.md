...
In alto a destra è presente il selettore del periodo di riferimento: è possibile selezionare un periodo suggerito (*Quest'anno, Anno Precedente, Mese Corrente, ...*) oppure indicare un intervallo personalizzato tramite una **Data di Inizio** e una **Data di Fine**.
...
* **Tabella Comparativa**: Elenco di tutti gli eventi con incasso, numero ordini, scontrino medio e data. Cliccando sul nome di un evento è possibile visualizzare le sue statistiche dettagliate.
...
* **Tabella Prodotti**: Mostra per ogni articolo le porzioni vendute, il fatturato generato, il prezzo medio e la quota percentuale sulle vendite totali.
  * *Cliccando sul nome del Prodotto è possibile visualizzare la scheda con il grafico delle vendite orarie e la distribuzione tra i vari eventi.*
...
* **Storico Ordini**: Tutti gli scontrini dell'evento visualizzati a schede. È possibile ordinarli in base a: *Più recenti*, *Meno recenti*, *Più costosi*, *Meno costosi*.
